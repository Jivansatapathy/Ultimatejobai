             ...
             <TabsContent value="jobs">
                <Card className="bg-secondary/10 border-white/5">
                   <CardHeader className="flex flex-row items-center justify-between">
                      <div>
                        <CardTitle>Global Jobs Database</CardTitle>
                        <CardDescription>Listing of all jobs extracted from platforms.</CardDescription>
                      </div>
                      <div className="flex items-center gap-2">
                         <Input placeholder="Search jobs/companies..." className="w-64 bg-background/50 border-white/10" />
                        ...
                        <TableBody>
                          {jobs.map(j => (
                            <TableRow key={j.id} className="border-white/5 hover:bg-white/5 transition-colors">
                              ...
                              <TableCell className="text-xs font-mono">{new Date(j.created_at).toLocaleDateString()}</TableCell>
                              <TableCell className="text-right">
                                {j.platform === 'lever' || j.platform === 'greenhouse' ? (
                                  <Dialog>
                                        ...
                                        {previewJob && (
                                          <div className="flex flex-col h-full">
                                            ...
                                            <div className="flex-grow relative bg-white">
                                               <iframe 
                                                 src={previewJob.platform === 'lever' && !previewJob.apply_url.includes('embed=true') 
